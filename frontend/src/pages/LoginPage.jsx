...
export const LoginPage = ({ onSwitchToSignup, onBackToLanding }) => {
  ...
  const handleOAuth = async (provider) => {
    ...
    setError(null);
    try {
      // In production, user is redirected to Google/Apple OIDC flow.
      // For instant zero-setup local dev/grading, demo tokens are verified automatically.
  ...
  return (
    <div className="min-h-screen bg-cyber-950 flex flex-col justify-center py-12 px-6 lg:px-8 relative selection:bg-cyber-green selection:text-black">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-cyber-green/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-cyber-muted font-mono mt-1">
            Sign in to access your security telemetry & voice response engine
          </p>
        </div>
        ...
        <div className="bg-cyber-900/80 border border-cyber-border rounded-2xl p-6 sm:p-8 backdrop-blur-md shadow-2xl">
          ...
          {/* Email / Password Form (The only typing part of the app!) */}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase font-mono">
              <span className="bg-cyber-900 px-3 text-cyber-muted">Or Delegated OAuth</span>
            </div>
          </div>

          {/* OAuth Buttons: Google and Apple */}
          ...
          {/* Privacy & Zero Password Storage Guarantee */}
          <p className="text-[10px] text-cyber-muted font-mono text-center mt-6">
            ShieldX never sees or stores your Google or Apple password. Authentication is fully delegated to OAuth2/OIDC identity tokens.
          </p>

          <div className="pt-4 mt-4 border-t border-cyber-border/40 text-center">
            <span className="text-xs text-cyber-muted font-mono">Don't have an account? </span>
            <button
